...
export function ContentDados() {
  ...
  if (dados === "Loading" || !dados || dados.length === 0)
    return (
      <div className="flex items-center justify-center w-full bg-dark-theme">
        <img
          src={spinnerLoading}
          alt="Loading"
                  ...
                  {nameAluno > -1 ? (
                    <p className="text-[#748FFC] font-bold">
                      {parseFloat(
                        dados[nameDisc].disciplinas.series[nameSerie].turmas[
                          nameTurma
                        ].alunos[nameAluno].total_tempo_aula / 360
                      ).toFixed(2)}{" "}
                      h
                    </p>
                  ) : (
                  ...
                  {nameAluno > -1 ? (
                    <p className="text-[#748FFC] font-bold">
                      {parseFloat(
                        dados[nameDisc].disciplinas.series[nameSerie].turmas[
                          nameTurma
                        ].alunos[nameAluno].total_tempo_atividade / 360
                      ).toFixed(2)}
                      h
                    </p>
                  ) : (
